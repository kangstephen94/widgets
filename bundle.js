          ...
          return _react2.default.createElement(
            ...
            { key: idx,
              onMouseDown: function onMouseDown() {
                return _this2.props.changeIndex(idx);
              } },
            tab.title
          );
        })
...
var Root = function Root() {
  var tabs = [{ title: "title1", content: "content1" }, { title: "title2", content: "content2" }, { title: "title3", content: "content3" }];
...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var pane = this.props.tabs[this.state.index];
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(
          'div',
          { className: 'tabs' },
          _react2.default.createElement(_header2.default, { changeIndex: this.changeIndex,
...
var Weather = function (_React$Component) {
  ...
  function Weather(props) {
    ...
    _this.getLocationData = _this.getLocationData.bind(_this);
    return _this;
  }

  _createClass(Weather, [{
    key: "getLocationData",
    value: function getLocationData(position) {
      var _this2 = this;

      var lon = "lon=" + String(position.coords.longitude);
      var lat = "lat=" + String(position.coords.latitude) + "&";
      var api = '&APPID=a6de4cdd788e53fbd09f6d2f8cfb5fa2';
      var url = 'http://api.openweathermap.org/data/2.5/weather?' + lat + lon + api;
